Meteor.startup(function() {
  ...
  Utils.tellIOSILoggedOut = function (delay) {
    ...
    if (Utils.getMobileOperatingSystem() === 'iOS') {
      setTimeout(function() {
        ...
        window.location = "toasterapp://loggedOut";
      }, delay);
    }
  }

  Utils.tellIOSILoggedIn = function (delay) {
    var delay = delay || 100;
    if (Utils.getMobileOperatingSystem() === 'iOS') {
      setTimeout(function() {
        console.log("told iOS I logged In: ", Meteor.userId())
        
        window.location = "toasterapp://loggedIn?userId="+Meteor.userId();
      }, delay);
    }
  }
  ...
  // Utils.getBadgeCount = function() {
  //   console.log("getBadgeCount called");

  //   Meteor.call("getNumUnreadNotis", function (err, numUnread) {
  //     console.log("returning numUnread", numUnread);
  //     // _.defer(function() {
  //       window.location = "toasterapp://badgeCount="+numUnread;  
  //     // })
