Meteor.startup(function() {
  ...
  Utils.tellIOSILoggedIn = function (delay) {
    ...
    if (Utils.getMobileOperatingSystem() === 'iOS') {
      setTimeout(function() {
        ...
        window.location.href = "toasterapp://loggedIn?userId="+Meteor.userId();
      }, delay);
    }
  }
  ...
  Utils.tellAndroidNotVerified = function(numUnread) {
    if (Utils.isNativeApp() && Utils.getMobileOperatingSystem() === 'Android') {
      setTimeout(function() {
        if (numUnread > 0) {
          alert('notVerified'); 
  ...
  Utils.tellAndroidIsVerified = function(numUnread) {
    if (Utils.isNativeApp() && Utils.getMobileOperatingSystem() === 'Android') {
      setTimeout(function() {
        if (numUnread > 0) {
          alert('isVerified'); 
  ...
  Utils.openIOSApp = function() {
    if (Utils.getMobileOperatingSystem() === 'iOS') {
      setTimeout(function() {
        alert("opening iOS app");
