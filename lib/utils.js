Meteor.startup(function() {
  ...
  Utils.isNativeApp = function() {
    ...
    var isAndroid = /Toaster\/[0-9\.]+$/.test(userAgent);
    var isIphone = (!isSafari && !isStandalone);
  ...
  Utils.tellIOSILoggedIn = function (isVerified) {
    if (Utils.getMobileOperatingSystem() === 'iOS') {
      setTimeout(function() {
        if (isVerified) {
          window.location.href = "toasterapp://loggedIn?verified=1";
        } else {
  ...
  Utils.openApp = function (userId) {
    
    if (Utils.getMobileOperatingSystem() === 'iOS') {
      setTimeout(function() {
        window.location.href = "yolk://verified";  
      }, 100);
    } 
    else if (Utils.getMobileOperatingSystem() === 'Android') {
      // alert("is android");
        setTimeout(function() {
          // Session.set("androidVerified", true);
          // alert("is android");
          // window.open("intent://com.yolknow.yolk");
         window.location.href = "yolk://com.yolknow.yolk";
